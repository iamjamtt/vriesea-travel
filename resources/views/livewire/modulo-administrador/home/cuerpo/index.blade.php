<div>
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Cuerpo</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Pagina cliente</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.home.cuerpo.index') }}">Cuerpo</a>
                            </li>
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <div class="alert-body">
            <strong>Recuerda - Solo pueden estar activos 2 items.</strong>
        </div>
    ...
    <div class="row" id="basic-table">
        <div class="col-12">
            <div class="mb-1" style="text-align: right">
                <button type="button" wire:click="modo()" class="btn btn-primary waves-effect" data-bs-toggle="modal" data-bs-target="#modalCuerpo">
                    Nuevo
                </button>
            </div>
            <div class="card">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="cursor: pointer" wire:click="cargarCuerpo({{ $item->id }})" class="text-success" data-bs-toggle="modal" data-bs-target="#modalCuerpo"><i class="ri-edit-line"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            @if ($home_cuerpo->count() == 0)
                                <tr>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade text-start" id="modalCuerpo" tabindex="-1" aria-labelledby="modalCuerpo" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" wire:click="guardarCuerpo()" class="btn btn-primary waves-effect waves-float waves-light">Guardar</button>
